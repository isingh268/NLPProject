...
Original file is located at
    https://colab.research.google.com/drive/13VDvJhdWMdKH0jio44LiWhz3CF_e7TeB
"""
...
# Scholarship Finder Page
    ...
    # Placeholder for scholarship search functionality
    st.markdown("Scholarship Finder functionality coming soon!")

# Scholarship Calendar Page
    ...
    # Display scholarships as a simple list
    st.markdown("### 📜 Upcoming Deadlines")
    for name, deadline in sorted(scholarships.items(), key=lambda x: x[1]):
        st.markdown(f"- **{name}**: {deadline.strftime('%B %d, %Y')}")

    # Detailed scholarship deadlines
    st.markdown("### 🗓️ Scholarship Deadlines Calendar")
    st.write("Interactive calendar feature coming soon!")
...
# About Page
    ...
    **SCU Scholarship Finder** is designed to assist Santa Clara University students in finding and applying for scholarships.
    ...
    - View upcoming deadlines in a calendar format.
